...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(twilio.actions.ParseResponseExceptionStringToObject.class);
			component.actionRegistry().registerUserAction(twilioconnector.actions.MakeCall.class);
			component.actionRegistry().registerUserAction(twilioconnector.actions.SendOutgoingMessage.class);
